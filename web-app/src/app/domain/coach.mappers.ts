...
import { addDays, daysBetween, startOfWeek } from '../core/dates';
import { formatDayMonthYear, formatDayShort, formatDecimal, formatHoursMinutes, toIsoDay } from '../core/format';

import type { AthleteFiche, AthleteSearchRow, AthleteStatus, CoachAthleteLite, CoachGroup, CoachHome, InviteOverview } from './coach.types';
...
/** Groupes de l'API → ce que l'écran affiche, avec l'échéance de la course. */
