...
export const sampleCoachAthletes: ApiCoachAthlete[] = [
  ...
  { _id: 'athlete-maxime', firstName: 'Maxime', lastName: 'Petit', email: 'maxime.petit@example.com', packageType: 'gold', joinedAt: '2025-09-01T09:00:00.000Z', nextCompetition: null, ...statusData('green', 0) },
  {
    _id: 'athlete-ines',
    firstName: 'Inès',
    lastName: 'Robert',
